...
if __name__ == "__main__":
    ...
    default_font, label_font, button_font = get_fonts(root)
    ...
    frame_top = ttk.Frame(root, padding=10, style="Form.TFrame")
    ...
    new_button = tk.Button(
        frame_top, text="+ New", command=clear_form,
        font=button_font,
    ...
    form_frame = ttk.Frame(root, padding=10, style="Form.TFrame")
    ...
    body_text = tk.Text(form_frame, wrap=tk.WORD)
    body_text.grid(row=2, column=1, sticky="nsew", pady=5)

    # Button Frame (Save/Delete/Cancel)
    button_frame = ttk.Frame(root, padding=10, style="Form.TFrame")
    button_frame.pack(pady=(0, 15))

    save_button = tk.Button(
        button_frame, text="Save", command=save_template,
        font=button_font,
        bg=BUTTON_COLOR, fg=BUTTON_TEXT,
        activebackground=BUTTON_HOVER, activeforeground=BUTTON_TEXT,
    ...
    delete_button = tk.Button(
        button_frame, text="Delete", command=delete_template,
        font=button_font,
        bg=BUTTON_COLOR, fg=BUTTON_TEXT,
        activebackground=BUTTON_HOVER, activeforeground=BUTTON_TEXT,
        relief="flat", borderwidth=0, padx=14, pady=6
    ...
    cancel_button = tk.Button(
        button_frame, text="Cancel", command=clear_form,
        font=button_font,
        bg=BUTTON_COLOR, fg=BUTTON_TEXT,
        activebackground=BUTTON_HOVER, activeforeground=BUTTON_TEXT,
        relief="flat", borderwidth=0, padx=14, pady=6
    ...
    # Event bindings
    name_entry.bind("<KeyRelease>", check_for_changes)
    subject_entry.bind("<KeyRelease>", check_for_changes)
    body_text.bind("<KeyRelease>", check_for_changes)

...
This page contains links to manager features -
 send notification, create template, view notification logs
and contains a button for the manager to exit to the login/signup home page.

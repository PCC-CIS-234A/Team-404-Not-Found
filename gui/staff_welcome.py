...
class StaffWelcome(tk.Frame):
    """
    Author: R-Nixon
    Creation Date: 2025-05-23
    Purpose: This class is a tkinter frame that contains the welcome page for staff.
    Only staff will see this page after a successful login.
    """

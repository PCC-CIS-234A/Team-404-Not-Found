...
class LogsPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        ttk.Label(details_frame, textvariable=details_text, justify=tk.LEFT, anchor=tk.W).pack(fill=tk.BOTH, padx=10,
                                                                                               pady=10)
        ...
        def search_click():
            ...
            if not results:
                ...
                for row in results:
                    ...
                    row["date_sent"], row["subject"], row["message"], row["first_name"], row["num_subscribers"]))
